    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto align-items-center">
                ...
                <?php if(isLoggedIn()): ?>
                    <li class="nav-item">
                        <a class="nav-link text-white font-weight-bold px-3" href="<?php echo BASE_URL; ?>my_orders.php">My Orders</a>
                    </li>
                    <?php if(isAdmin()): ?>
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold px-3" href="<?php echo BASE_URL; ?>admin/index.php" style="color: var(--secondary-color);">Admin Dashboard</a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link text-white font-weight-bold px-3" href="<?php echo BASE_URL; ?>logout.php">Logout</a>
                    </li>
                <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link text-white font-weight-bold px-3" href="<?php echo BASE_URL; ?>login.php">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn font-weight-bold ml-lg-2 px-4 py-2 text-dark shadow-sm" href="<?php echo BASE_URL; ?>register.php" style="background-color: var(--secondary-color); border-radius: 8px;">Sign Up</a>
                    </li>
                <?php endif; ?>
            </ul>
        </div>
