    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4 mb-lg-0">
                ...
                <div class="carousel-inner h-100">
                                    ...
                                    <div class="banner-content text-white p-5 d-flex flex-column justify-content-center" style="width: 45%;">
                                        ...
                                        <div>
                                            <form action="cart_action.php" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn text-dark font-weight-bold px-4 py-2" style="background-color: var(--secondary-color); border: none; border-radius: 8px;"><i class="fas fa-shopping-cart mr-2"></i> <?php echo __('Add to Cart'); ?></button>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="carousel-item active h-100">
                            <div class="woolworths-banner d-flex h-100">
                                <div class="banner-content text-white p-5 d-flex flex-column justify-content-center" style="width: 45%;">
                                    <h2 class="font-weight-bold mb-3" style="font-size: 2.5rem; line-height: 1.1;"><?php echo __('Welcome to Moonlight'); ?></h2>
                                    <p class="mb-4" style="font-size: 1.1rem;"><?php echo __('Discover fresh produce and daily essentials.'); ?></p>
                                    <div>
                                        <a href="products.php" class="btn text-dark font-weight-bold px-4 py-2" style="background-color: var(--secondary-color); border: none; border-radius: 8px;"><?php echo __('Shop now'); ?></a>
                                    </div>
                                </div>
                                <div class="banner-image">
            ...
            <div class="d-flex justify-content-between mt-3 text-muted align-items-center">
                <span class="font-weight-bold"><?php echo __('Daily Featured Products'); ?></span>
        ...
        <!-- Right Menu -->
        <div class="col-lg-4">
            <h3 class="font-weight-bold mb-2"><?php echo __('Welcome to Moonlight'); ?></h3>
            <?php if(isLoggedIn()): ?>
                <p class="text-muted mb-3" style="font-size: 1.1rem;"><?php echo __('Welcome Back'); ?>, <span class="font-weight-bold text-dark"><?php echo htmlspecialchars($_SESSION['user_name']); ?></span>!</p>
            <?php else: ?>
                <p class="text-muted mb-3" style="font-size: 1.1rem;">Get the most out of your shop<br>
                <a href="login.php" class="text-success text-decoration-underline font-weight-bold"><?php echo __('Login'); ?></a></p>
            <?php endif; ?>
            ...
            <div class="quick-links d-flex flex-column gap-2 mt-4">
                <a href="products.php" class="quick-link-card d-flex justify-content-between align-items-center p-3 mb-2 bg-white border rounded shadow-sm text-dark text-decoration-none">
                    <div>
                        ...
                        <span class="font-weight-bold text-decoration-underline"><?php echo __('Catalogue'); ?></span>
                    </div>
                ...
                <a href="products.php?offer=1" class="quick-link-card d-flex justify-content-between align-items-center p-3 mb-2 bg-white border rounded shadow-sm text-dark text-decoration-none">
                    <span class="font-weight-bold text-decoration-underline"><?php echo __('All Specials & Offers'); ?></span>
                    <i class="fas fa-tag text-warning fa-2x"></i>
                </a>
                
                <a href="products.php" class="quick-link-card d-flex justify-content-between align-items-center p-3 mb-2 bg-white border rounded shadow-sm text-dark text-decoration-none">
                    <span class="font-weight-bold text-decoration-underline"><?php echo __('Ways to Shop'); ?></span>
                ...
                <a href="products.php?category=9" class="quick-link-card d-flex justify-content-between align-items-center p-3 mb-2 bg-white border rounded shadow-sm text-dark text-decoration-none">
                    <span class="font-weight-bold text-decoration-underline"><?php echo __('Healthylife +Pharmacy'); ?></span>
                ...
                <a href="products.php?category=10" class="quick-link-card d-flex justify-content-between align-items-center p-3 mb-2 bg-white border rounded shadow-sm text-dark text-decoration-none">
                    <span class="font-weight-bold text-decoration-underline"><?php echo __('Everyday Extra'); ?></span>
                ...
                <a href="products.php?category=11" class="quick-link-card d-flex justify-content-between align-items-center p-3 mb-2 bg-white border rounded shadow-sm text-dark text-decoration-none">
                    <span class="font-weight-bold text-decoration-underline"><?php echo __('Fresh Market Update'); ?></span>
...
<div class="container mt-5">
    <h2 class="font-weight-bold mb-4 text-center"><?php echo __('Daily Offers'); ?></h2>
                    ...
                    <div class="offers-slide d-flex flex-column flex-md-row">
                        ...
                        <div class="offers-content-panel p-4 p-md-5">
                            <span class="badge badge-warning text-dark mb-3 align-self-start px-3 py-2 font-weight-bold" style="border-radius: 30px; letter-spacing: 0.5px; font-size: 0.8rem;">
                                <i class="fas fa-percentage mr-1"></i> <?php echo __('Special Offer'); ?>
                            </span>
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <span class="badge badge-outline-dark text-dark border border-dark px-2 py-1 small" style="opacity: 0.8;"><?php echo __('Fresh Daily'); ?></span>
                            </div>
                            <form action="cart_action.php" method="POST" class="d-inline">
                                <input type="hidden" name="action" value="add">
                                <input type="hidden" name="product_id" value="<?php echo $offer->id; ?>">
                                <button type="submit" class="btn btn-warning text-dark font-weight-bold px-4 py-2 shadow-sm" style="border-radius: 30px;"><i class="fas fa-cart-plus mr-2"></i> <?php echo __('Add to Cart'); ?></button>
                            </form>
                        </div>
...
<div class="mt-5 pt-4">
    <div class="d-flex justify-content-between align-items-end mb-4">
        <h2 class="font-weight-bold"><?php echo __('Featured Products'); ?></h2>
        <a href="products.php" class="text-primary text-decoration-none font-weight-bold"><?php echo __('View All'); ?> <i class="fas fa-chevron-right ml-1"></i></a>
    </div>
